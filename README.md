...
into your expression by pressing <kbd>C-;</kbd>.
...
So how do you choose what ,lmode to use?  Use normal mode if you want to 
transform collection data and you don't care about code generation.
...
the expression prompt by pressing <kbd>C-;</kbd>, which is the key
